            ...
            <div className="bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-55 relative" >
                ...
                <form action="">
                    <div className="relative my-10">
                        <input type="email" required className="block w-72 py-1 pr-11 text-base text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer "
                    ...
                    <div className="relative my-4">
                        <input type={showPassword ? "text" : "password"} required className="block w-72 py-1 pr-12 text-base text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer"
                            placeholder="" />
                    ...
                    <button className="w-full mb-4 text-[18px] mt-6 rounded-full bg-blue-500 text-white hover:bg-blue-700 hover:text-white py-2 transition-colors duration-300">Login</button>
                </form>
